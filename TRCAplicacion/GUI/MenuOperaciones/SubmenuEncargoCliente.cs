    ...
    public partial class SubmenuEncargoCliente : Form
    {
        ...
        private void mostrarEstadoEncargoComboBox()
        {
            ...
            if (dtEstadoEncargo.Rows.Count > 0)
            {
                ...
                {
                    cbEstadoEncargo.Items.Add(dtEstadoEncargo.Rows[i][1].ToString());
                }
            }
                ...
                nuCantidadProducto.Value != 0)
            {
                try
                {
                    ...
                    if (!verificarProductoLista)
                    {
                        ...
                        MessageBox.Show("El encargo del cliente se agrego a la lista", "Atencion", MessageBoxButtons.OK, MessageBoxIcon.Information);
